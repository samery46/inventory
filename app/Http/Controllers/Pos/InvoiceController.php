...
class InvoiceController extends Controller
{
    ...
    {
        $ids = Auth::user()->id;
        $adminData = User::find($ids);
        $invoice = Invoice::with('invoice_details')->findOrFail($id);
        return view('backend.pdf.invoice_pdf', compact('invoice', 'adminData'));
    } // End Method
    ...
    public function DailyInvoicePdf(Request $request)
    {
        ...
        return view('backend.pdf.daily_invoice_report_pdf', compact('allData', 'start_date', 'end_date', 'adminData'));
    } // End Method

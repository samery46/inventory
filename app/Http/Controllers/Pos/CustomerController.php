...
class CustomerController extends Controller
{
    ...
    public function CreditCustomerPrintPdf()
    {
        ...
        $allData = Payment::whereIn('paid_status', ['full_due', 'partial_paid'])->get();
        return view('backend.pdf.customer_credit_pdf', compact('allData', 'adminData'));
    } // End Method
    ...
    public function PaidCustomerPrintPdf()
    {
        ...
        $adminData = User::find($id);
        $allData = Payment::where('paid_status', '!=', 'full_due')->get();
        return view('backend.pdf.customer_paid_pdf', compact('allData', 'adminData'));
    } // End Method
    ...
    public function CustomerWiseCreditReport(Request $request)
    {
        ...
        return view('backend.pdf.customer_wise_credit_pdf', compact('allData', 'adminData'));
    } // End Method
    ...
    public function CustomerWisePaidReport(Request $request)
    {
        ...
        return view('backend.pdf.customer_wise_paid_pdf', compact('allData', 'adminData'));
    } // End Method
